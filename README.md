...
## To Do:
I will upload a circuit diagram of the project shortly. The cap that is mounted on the lower servo and attatched to the belt cant provide enough friction to reliably turn the lamp. I will either mount the lower arm of the lamp directly on the servo, or will do a full rebuild of the assembly using 3D printed parts. 
